                                ...
                                <form action="#">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label fclass="form-control">Username</label>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="<?= $data[0]["username"] ?>" placeholder="col-md-11">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label fclass="form-control">Password</label>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="<?= $data[0]["password"] ?>" placeholder="col-md-11">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label fclass="form-control">Role</label>
                                                </div>
                                            </div>                                            
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="<?= $data[0]["role"] ?>" placeholder="col-md-11">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
